...
public class FridgeActivity extends AppCompatActivity implements OnFridgeItemInteractionListener {
    ...
    @Override
    public void onFridgeItemAddOneClickedListener(Beer beer) {
        model.addOneItemInFridge(beer.getId());
    }

    @Override
    public void onFridgeItemRemoveOneClickedListener(Beer beer) {
        model.removeOneItemInFridge(beer.getId());
    }
}
