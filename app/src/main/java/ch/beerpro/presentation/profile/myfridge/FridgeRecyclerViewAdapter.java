...
public class FridgeRecyclerViewAdapter extends ListAdapter<Pair<FridgeItem, Beer>, FridgeRecyclerViewAdapter.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.removeOneFromFridge)
        Button remove;

        @BindView(R.id.amount)
        TextView amount;

        @BindView(R.id.addOneToFridge)
        Button add;
        ...
        void bind(FridgeItem fridgeItem, Beer item, OnFridgeItemInteractionListener listener) {
            ...
            remove.setOnClickListener(v -> listener.onFridgeItemRemoveOneClickedListener(item));
            add.setOnClickListener(v -> listener.onFridgeItemAddOneClickedListener(item));
        }
